...
//        return getString(AppConstants.PREFERECENCE_UTILLS.API_TOKEN, "")!!
//    }
    fun SharedPreferences.getDeviceToken(): String {
        return getString(AppConstants.PREFERECENCE_UTILLS.DEVICE_TOKEN, "")!!
    }
